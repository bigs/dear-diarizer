...
def main():
    parser = argparse.ArgumentParser(
        description="Download top podcasts from Apple Podcasts."
    )
    parser.add_argument(
        "-n",
        "--num-podcasts",
        type=int,
        default=10,
        help="Number of top podcasts to fetch (default: 10)",
    )
    parser.add_argument(
        "-e",
        ...
        type=int,
        default=1,
        help="Number of latest episodes to download per podcast (default: 1)",
    )
    parser.add_argument(
        "-d",
        "--download-dir",
    ...
    parser.add_argument(
        ...
        type=str,
        default="podcasts.db",
        help="Path to the deduplication database (default: podcasts.db)",
    )
    parser.add_argument(
        "--country",
        type=str,
        default="us",
        help="Country code for Apple Charts (default: us)",
    )
